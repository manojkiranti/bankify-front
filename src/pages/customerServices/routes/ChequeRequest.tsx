...
const columns: ColumnsType<ServiceRequest> = [
  ...
  {
    title: 'No of leaves',
    dataIndex: ["data","no_of_leaves"],
    key: 'no_of_leaves'
  },
  {
    title: 'Is Collector Different',
    dataIndex: ["data","is_collector_different"],
    key: 'is_collector_different',
    render: (isCollectorDifferent: string) => {
      return isCollectorDifferent ? "Yes" : "No"
    },
  },
  {
    title: 'Status',
